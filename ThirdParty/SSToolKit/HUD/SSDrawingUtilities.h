...
extern CGGradientRef SSGradientWithColors(UIColor *topColor, UIColor *bottomColor) CF_RETURNS_NOT_RETAINED;
extern CGGradientRef SSGradientWithColorsAndLocations(UIColor *topColor, UIColor *bottomColor, CGFloat topLocation, CGFloat bottomLocation) CF_RETURNS_NOT_RETAINED;

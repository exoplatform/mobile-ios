...
//		domainName = [domainName substringFromIndex:tmpRange1.location + tmpRange1.length];
//	tmpRange1 = [domainName rangeOfString:@":"];
//	if(tmpRange1.length > 0)
//		domainName = [domainName substringToIndex:tmpRange1.location];
	
	[xmppStream connectToHost:self.domain onPort:port withVirtualHost:self.domain];

...
// Notifications
//   - key of device token value in preferences, used for remote notifications
#define NOTIFICATIONS_DEVICE_TOKEN @"notifications_device_token"
#define NOTIFICATIONS_REGISTRATIONS_PATH @"exo-mobile-notifications/registrations"
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    headerLabel.frame = CGRectMake(25.0, 11.0, theSize.width, kHeightForSectionHeader);
    ...
    imgVBackground.frame = CGRectMake(15, 16.0, theSize.width + 20, kHeightForSectionHeader-15);
...
{    
    ...
    if (cell==nil) 
    {
        ...
        UILabel* titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(65.0, 3.0, 210.0, 20.0)];
        ...
        UILabel* descriptionLabel = [[UILabel alloc] initWithFrame:CGRectMake(65.0, 20.0, 210.0, 33.0)];

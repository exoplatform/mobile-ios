...
- (void)changeOrientation:(UIInterfaceOrientation)interfaceOrientation
{
	...
	if(_selectedLanguage == 0)
	{
		urlHelp = [NSURLRequest requestWithURL:[NSURL fileURLWithPath: [[NSBundle mainBundle] pathForResource:@"HowtoUse-EN" ofType:@"html"]]];		
	}
	else 
	{
		urlHelp = [NSURLRequest requestWithURL:[NSURL fileURLWithPath: [[NSBundle mainBundle] pathForResource:@"HowtoUse-FR" ofType:@"html"]]];
	}

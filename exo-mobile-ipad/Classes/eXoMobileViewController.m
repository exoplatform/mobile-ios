...
- (void)setSelectedLanguage:(int)languageId
{
	...
	{
		strLocalizeFilePath = [[[NSBundle mainBundle] pathForResource:@"LocalizeEN" ofType:@"xml"] retain];
	}	
	else if(_intSelectedLanguage == 1)
	{	
		strLocalizeFilePath = [[[NSBundle mainBundle] pathForResource:@"LocalizeFR" ofType:@"xml"] retain];
	}	
